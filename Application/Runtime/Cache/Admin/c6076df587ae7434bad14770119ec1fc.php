...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <form class="form form-horizontal" id="form-article-add" action="/index.php/Admin/Order/order_add" method="post" enctype="multipart/form-data">
        <!-- 隐藏域为机台id -->
        
        <input type="hidden" name="log_id" value="<?php echo ($log_id); ?>">
        <div class="row cl from-group" align="center" >
        <a href="/index.php/Admin/Order/log_index" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe67f;</i>&emsp;返回列表页&emsp;</a>
                &emsp;&emsp;<span class="btn btn-default radius"><i class="Hui-iconfont">&#xe6df;</i>&emsp;添加物流信息</span>
        </div>
        <div class="row cl from-group">
    
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>收货人姓名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text form-control" value="<?php echo ($data["name"]); ?>" id="name" name="name">
            </div>
        ...
        <div class="row cl from-group">
            ...
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>收货人手机：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text form-control" value="<?php echo ($data["phone"]); ?>"  id="phone" name="phone">
            </div>
        ...
        <div class="row cl from-group">
            ...
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>收货人地址：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text form-control" value="<?php echo ($data["address"]); ?>"  id="address" name="address">
            </div>
        ...
        <div class="row cl from-group">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text form-control" value=""  id="trace_number" name="trace_number">
            </div>
    ...
    <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                <select name="express_id" class="select" id="express_id">
                    <option value="">==选择快递==</option>
                    <!--快递类型id-->
                    <?php if(is_array($express)): $i = 0; $__LIST__ = $express;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["express_id"]); ?>"><?php echo ($v["express_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                </span> </div>
        </div>
        ...
        <div class="row cl from-group">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button class="btn btn-primary radius" type="submit" id="addgood"><i class="Hui-iconfont">&#xe632;</i> 点击提交</button>
    ...
    //实例化编辑器
      ...
      $("#form-article-add").bootstrapValidator({
        ...
        fields: {
            ...
            phone: {
                validators: {
                    notEmpty: { message: '请输入收货人手机' },
          
                    regexp: { regexp: /^1[3|4|5|7|8][0-9]{9}$/, message: '手机号码格式不正确' }
                }
            },
             address: {
                validators: {
                    notEmpty: { message: '请输入收货人地址' },
                   
                }
            },
              trace_number: {
                validators: {
                    notEmpty: { message: '请输入快递单号' },
                  
                }
            },
              express_id: {
                validators: {
                    notEmpty: { message: '请选择快递公司' },
