...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i><a href="/index.php/Admin/Index/index">首页</a> <span class="c-gray en">&gt;</span> 机台管理 <span class="c-gray en">&gt;</span> 机台分配 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				...
				<tbody>
				<?php if(is_array($manager)): $i = 0; $__LIST__ = $manager;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr class="text-c">
						<td><?php echo ($vol["id"]); ?></td>
						<td><?php echo ($vol["nickname"]); ?></td>
						
						<td><?php echo ($vol["equipment_ids"]); ?></td>
						<td class="f-14"><a title="分配机台" href="/index.php/Admin/Equipment/setauth/id/<?php echo ($vol["id"]); ?>" onclick="" style="text-decoration:none"><i class="Hui-iconfont">&#xe600;</i></a> <a title="撤销分配" href="/index.php/Admin/Equipment/delsetauth/id/<?php echo ($vol["id"]); ?>" onclick=""><i class="Hui-iconfont">&#xe6a1;;</i></a></td>
	...
	$('#delAll').click(function(){
		...
		layer.confirm('确认删除？',function(){
			$.ajax({
				...
				'dataType':'json',
				'data':'ids='+ids,
				'url':'/index.php/Admin/Equipment/delAll',
