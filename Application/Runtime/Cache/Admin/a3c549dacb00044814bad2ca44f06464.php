				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td><?php echo ($v["id"]); ?></td>
							<td class="text-l"><?php echo ($v["phone"]); ?></td>
							<td class="text-l"><a href=""><center><?php echo ($v["address"]); ?></center></td>
							<td><font color="blue"><?php echo (date("Y-m-d H:i:s",$v["create_time"])); ?></font></td><!--订单创建的时间-->
							<td><font color="red"><b><?php echo (date("Y-m-d",$v["send_time"])); ?></b></font></td><!--物流发货的时间-->
							...
							<td class="f-14 td-manage">
								<a style="text-decoration:none" class="ml-5" href="/index.php/Admin/Order/order_edit/id/<?php echo ($v["id"]); ?>" title="商品编辑"><i class="Hui-iconfont">&#xe6df;编辑</i></a>
								<a style="text-decoration:none" class="ml-5" onClick="equipment_del(this,'<?php echo ($v["id"]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;删除</i></a>
								</td>
