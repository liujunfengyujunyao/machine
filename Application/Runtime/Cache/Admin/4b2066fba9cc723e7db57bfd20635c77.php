...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<div class="row cl from-group">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text form-control" value="<?php echo ($equipment["odds2"]); ?>"  id="odds1lv2" name="odds1lv2" style="display: inline;width:50%;"" oninput="myFunction2()">
			</div>
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>抓取率LV3：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text form-control" value="<?php echo ($equipment["odds3"]); ?>"  id="odds1lv3" name="odds1lv3" style="display: inline;width:50%;" oninput="myFunction3()">
			</div>
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>抓取率LV4：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text form-control" value="<?php echo ($equipment["odds4"]); ?>"  id="odds1lv4" name="odds1lv4" style="display: inline;width:50%;" oninput="myFunction4()">
			</div>
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>抓取率LV5：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text form-control" value="<?php echo ($equipment["odds5"]); ?>"  id="odds1lv5" name="odds1lv5" style="display: inline;width:50%;">
			</div>
...
function myFunction2(){
	document.getElementById('odds1lv3').value=document.getElementById('odds1lv2').value;
	document.getElementById('odds1lv4').value=document.getElementById('odds1lv2').value;
	document.getElementById('odds1lv5').value=document.getElementById('odds1lv2').value;
}
function myFunction3(){
	document.getElementById('odds1lv4').value=document.getElementById('odds1lv3').value;
	document.getElementById('odds1lv5').value=document.getElementById('odds1lv3').value;
}
function myFunction4(){
	document.getElementById('odds1lv5').value=document.getElementById('odds1lv4').value;
}
</script>
<!--/请在上方写此页面业务相关的脚本-->
