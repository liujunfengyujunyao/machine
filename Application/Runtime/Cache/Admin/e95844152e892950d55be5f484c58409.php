...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="#" class="btn btn-danger radius" id="delAll"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="/index.php/Admin/Manager/role_add" onclick=""><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r"></div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				...
				<?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><tr class="text-c">
						...
						<td><?php echo ($role_auth[$key]); ?></td>
						<td class="f-14"><a title="编辑" href="/index.php/Admin/Manager/role_edit/role_id/<?php echo ($vol["role_id"]); ?>" onclick="" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="#" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Manager/role_del/role_id/<?php echo ($vol["role_id"]); ?>'"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
